...
CATALINA_OPTS="${CATALINA_OPTS} -Xms768m -Xmx768m -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=128m"
CATALINA_OPTS="${CATALINA_OPTS} -XX:+UseG1GC"
CATALINA_OPTS="${CATALINA_OPTS} -verbose:gc -Xlog:gc*"
CATALINA_OPTS="${CATALINA_OPTS} -Xlog:gc:/app/{{ Server_Root }}/logs/gc/gc-$(date '+%Y-%m-%d').log"
CATALINA_OPTS="${CATALINA_OPTS} -D{{ Instance_Name }}"
##### JMX #####
CATALINA_OPTS="${CATALINA_OPTS} -Dcom.sun.management.jmxremote=true"
CATALINA_OPTS="${CATALINA_OPTS} -Dcom.sun.management.jmxremote.port={{ Listen_Jmx }}"
